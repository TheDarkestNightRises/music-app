...
public class UsersDAOImpl implements UsersDAO {
    ...
    @Override
    public Playlist getPlaylistFromUserById(User user, int id) {
        try {
            PreparedStatement statement0 = getConnection().prepareStatement("SET SCHEMA 'music_app'");
            PreparedStatement statement = getConnection().prepareStatement(
    ...
    @Override
    public Playlist getPlaylistIdFromUserByName(User user, String title) {
        try {
            PreparedStatement statement0 = getConnection().prepareStatement("SET SCHEMA 'music_app'");
            PreparedStatement statement = getConnection().prepareStatement(
    ...
    @Override
    public ArrayList<Playlist> getAllPlaylistsFromUser(User user) {
        try {
            PreparedStatement statement0 = getConnection().prepareStatement("SET SCHEMA 'music_app'");
            PreparedStatement statement = getConnection().prepareStatement(
    ...
    @Override
    public void uploadPicture(String username, String pictureName) {
        try {
            PreparedStatement statement0 = connection.prepareStatement("SET SCHEMA 'music_app'");
            PreparedStatement statement = connection.prepareStatement(
