...
public class AlbumDAOImpl implements AlbumDao
{
  ...
  @Override public void insertAlbum(String title, int publication_year, String picture, Artist artist)
  {
    ...
    {
      PreparedStatement statement0 = connection.prepareStatement("SET SCHEMA 'music_app'");
      PreparedStatement statement = connection.prepareStatement("INSERT INTO album(album_id, title, publication_year, picture_path, username) "
          + "VALUES (?, ?, ?, ?, ?);");
      statement.setInt(1,PreparedStatement.RETURN_GENERATED_KEYS); // keys are not autogenerated
