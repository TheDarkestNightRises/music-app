...
public class MainMenuServerImpl implements MainMenuServer
{
  ...
  @Override public ArrayList<Song> fetchRandomSongs()
  {
    return serverModel.getModelMainMenu().fetchRandomSongs();
  }

  @Override public ArrayList<Song> fetchLastSongs() throws RemoteException
  {
    return serverModel.getModelMainMenu().fetchLastSongs();
  }

  @Override public ArrayList<Album> fetchRandomAlbums() throws RemoteException
  {
